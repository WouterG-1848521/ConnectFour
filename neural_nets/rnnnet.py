...
class rnnNet(Network):
    ...
    def initData(self):
        ...
        self.test_features = self.test_features.reshape(self.test_features.shape[0], self.test_features.shape[1], 1)
        self.train_features = self.train_features.reshape(self.train_features.shape[0], self.train_features.shape[1], 1)
    ...
    def addLayers(self):
        ...
        self.model.add(tf.keras.layers.SimpleRNN(512, input_shape=(42, 1), activation='relu', kernel_regularizer=regularizer))
